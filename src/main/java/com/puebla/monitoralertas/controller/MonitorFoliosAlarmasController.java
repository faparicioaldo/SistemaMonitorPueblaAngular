...
import com.puebla.monitoralertas.dto.EnviarFolioAlarmaDTO;
import com.puebla.monitoralertas.entity.FolioAlarmaEntity;
import com.puebla.monitoralertas.repository.FolioAlarmaRepository;
...
public class MonitorFoliosAlarmasController {
	...
	public @ResponseBody EnviarFolioAlarmaDTO enviarFolioAlarma(@RequestBody EnviarFolioAlarmaDTO folioAlarmaID) {
		...
		folioAlarmaRepository.updateFolioAlarmaEstatusFechaCierreByFolioid(folioAlarmaID.getIdFolioAlarma(),"Atendido", new Date());
	...
	public @ResponseBody EnviarFolioAlarmaDTO descartarFolioAlarma(@RequestBody EnviarFolioAlarmaDTO folioAlarmaID) {
		...
		folioAlarmaRepository.updateFolioAlarmaEstatusFechaCierreByFolioid(folioAlarmaID.getIdFolioAlarma(),"Cerrado",new Date());
